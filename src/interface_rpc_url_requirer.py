...
class RpcUrlRequirer(Object):
    ...
    def __init__(self, charm, relation_name):
        ...
        self.framework.observe(charm.on[relation_name].relation_changed, self._update_service_args)
        self.framework.observe(charm.on[relation_name].relation_departed, self._update_service_args)
